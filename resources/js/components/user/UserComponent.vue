                                        ...
                                        <div class="dropdown">
                                            ...
                                            >
                                                ...
                                                <!-- <a
                                                    ...
                                                    "
                                                    ><i
                                                        class="mdi mdi-settings-outline mr-2 text-dark"
                                                    ></i
                                                    >Status By</a
                                                > -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class=" row" v-show="filter.dateby">
                            <DateFilter
                                :datepickershow="true"
                                v-on:datalist="datefilter_data($event)"
...
>>>>>>> 2fbc31c6a38a2f838d858ef75b11f829aae33ca6
                        ...
                        <!-- <div class=" row" v-show="filter.statusby">
                                <StatusBy buttonname="Filter" :statusshow="true" apiurl="user/status/by"></StatusBy>
                        </div> -->
                        <!-- End col -->
                    </div>
                </div>
