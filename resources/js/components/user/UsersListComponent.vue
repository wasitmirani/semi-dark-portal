                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="item in users.data" :key="item.id">
                            ...
                            <td>
                                <h5>
                                    <a role="button" @click="editdata(item)"
                                        ><i
                                            class="mdi mdi-circle-edit-outline text-primary"
                                        ></i
                                    ></a>
                                    |
                                    <a role="button" @click="deletedata(item)"
                                        ><i
                                            class="mdi mdi mdi-trash-can text-danger"
                                        ></i
                                    ></a>
                                </h5>
                            </td>
